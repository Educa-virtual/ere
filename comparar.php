...
?>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="card">
                <h6 class="card-header">.:: <i class="far fa-file-alt"></i> COMPARATIVO POR COMPARATIVO AÑO </h6>
                <div class="card-body respuestag">

                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">PRUEBA DE SALIDA</label>
        ...
        <script>
            $('.enviar').click(function() {
                ...
                if (nivel == '' || curso == '' || grado == '') {
                    ...
                    $.ajax({
                            url: 'resultadosinformacionactualcompararano.php',
                            type: 'POST',
                            data: ruta,
                            dataType: 'html',
                            beforeSend: function() {
