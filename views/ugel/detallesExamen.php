        ...
        <table class="table table-sm table-bordered  table-striped table-hover">
            <thead>
                <tr class="tablatitulo text-center">
                    ...
                    <th scope="col" colspan="4" class="align-middle">EXÁMENES</th>
                </tr>
                <tr class="tablatitulo text-center">
                    <th scope="col" colspan="2">Gral.</th>
                    <th scope="col" colspan="2">Especial</th>
                </tr>
            </thead>
            <tbody class="areasarchivo">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="<?=($d['examen1']!='')?$d['examen1']:'#';?>">
                            <?=($d['examen1']!='')?'Descargar':'Pendiente';?>
                        </a>
                       <?php } else {?>
                        <span class="text-danger">Pendiente</span>
                        <?php 
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn <?=($d['validacion1']!='1')?'btn-danger':'btn-success';?>"
                            data-toggle="modal" data-target="#modalValidar" data-area="<?=$d['area']?>"
                            data-historial="<?=$d['historial_id']?>" data-detalle="<?=$d['detalle_id']?>"
                            data-ugel="<?=$d['ugel']?>" data-codmodular="<?=$d['codmodular']?>"
                            ...
                            <i class="far fa-check-circle"></i>
                            <?=($d['validacion1']!='1')?'Validar':'Validado';?>
                        </button>
                    </td>
                </tr>
                <?php  
