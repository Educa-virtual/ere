...
?>
    ...
    <body>
        ...
        $matrist1 = $asistencia->matrisres($curso, $grado, $nivel, '1', $evaluaci);
        while ($maser1 = mysqli_fetch_array($matrist1)) {
            $demoab1 = $maser1['clave'];
            $nivel1a = $maser1['nivelp'];
            $competencia1a = $maser1['competencia'];
            $desempeno1a = $maser1['desempeno'];
            $items1 = $maser1['item'];
            $estado1 = $maser1['estado'];
        }
        ...
        $matrist2 = $asistencia->matrisres($curso, $grado, $nivel, '2', $evaluaci);
        while ($maser2 = mysqli_fetch_array($matrist2)) {
            $demoab2 = $maser2['clave'];
            $nivel2a = $maser2['nivelp'];
            $competencia2a = $maser2['competencia'];
            $desempeno2a = $maser2['desempeno'];
            $items2 = $maser2['item'];
            $estado2 = $maser2['estado'];
        }
        ...
        $matrist3 = $asistencia->matrisres($curso, $grado, $nivel, '3', $evaluaci);
        while ($maser3 = mysqli_fetch_array($matrist3)) {
            $demoab3 = $maser3['clave'];
            $nivel3a = $maser3['nivelp'];
            $competencia3a = $maser3['competencia'];
            $desempeno3a = $maser3['desempeno'];
            $items3 = $maser3['item'];
            $estado3 = $maser3['estado'];
        }

        $matrist4 = $asistencia->matrisres($curso, $grado, $nivel, '4', $evaluaci);
        while ($maser4 = mysqli_fetch_array($matrist4)) {
            $demoab4 = $maser4['clave'];
            $nivel4a = $maser4['nivelp'];
            $competencia4a = $maser4['competencia'];
            $desempeno4a = $maser4['desempeno'];
            $items4 = $maser4['item'];
            $estado4 = $maser4['estado'];
        }

        $matrist5 = $asistencia->matrisres($curso, $grado, $nivel, '5', $evaluaci);
        while ($maser5 = mysqli_fetch_array($matrist5)) {
            $demoab5 = $maser5['clave'];
            $nivel5a = $maser5['nivelp'];
            $competencia5a = $maser5['competencia'];
            $desempeno5a = $maser5['desempeno'];
            $items5 = $maser5['item'];
            $estado5 = $maser5['estado'];
        }

        $matrist6 = $asistencia->matrisres($curso, $grado, $nivel, '6', $evaluaci);
        while ($maser6 = mysqli_fetch_array($matrist6)) {
            $demoab6 = $maser6['clave'];
            $nivel6a = $maser6['nivelp'];
            $competencia6a = $maser6['competencia'];
            $desempeno6a = $maser6['desempeno'];
            $items6 = $maser6['item'];
            $estado6 = $maser6['estado'];
        }

        $matrist7 = $asistencia->matrisres($curso, $grado, $nivel, '7', $evaluaci);
        while ($maser7 = mysqli_fetch_array($matrist7)) {
            $demoab7 = $maser7['clave'];
            $nivel7a = $maser7['nivelp'];
            $competencia7a = $maser7['competencia'];
            $desempeno7a = $maser7['desempeno'];
            $items7 = $maser7['item'];
            $estado7 = $maser7['estado'];
        }

        $matrist8 = $asistencia->matrisres($curso, $grado, $nivel, '8', $evaluaci);
        while ($maser8 = mysqli_fetch_array($matrist8)) {
            $demoab8 = $maser8['clave'];
            $nivel8a = $maser8['nivelp'];
            $competencia8a = $maser8['competencia'];
            $desempeno8a = $maser8['desempeno'];
            $items8 = $maser8['item'];
            $estado8 = $maser8['estado'];
        }

        $matrist9 = $asistencia->matrisres($curso, $grado, $nivel, '9', $evaluaci);
        while ($maser9 = mysqli_fetch_array($matrist9)) {
            $demoab9 = $maser9['clave'];
            $nivel9a = $maser9['nivelp'];
            $competencia9a = $maser9['competencia'];
            $desempeno9a = $maser9['desempeno'];
            $items9 = $maser9['item'];
            $estado9 = $maser9['estado'];
        }

        $matrist10 = $asistencia->matrisres($curso, $grado, $nivel, '10', $evaluaci);
        while ($maser10 = mysqli_fetch_array($matrist10)) {
            $demoab10 = $maser10['clave'];
            $nivel10a = $maser10['nivelp'];
            $competencia10a = $maser10['competencia'];
            $desempeno10a = $maser10['desempeno'];
            $items10 = $maser10['item'];
            $estado10 = $maser10['estado'];
        }

        $matrist11 = $asistencia->matrisres($curso, $grado, $nivel, '11', $evaluaci);
        while ($maser11 = mysqli_fetch_array($matrist11)) {
            $demoab11 = $maser11['clave'];
            $nivel11a = $maser11['nivelp'];
            $competencia11a = $maser11['competencia'];
            $desempeno11a = $maser11['desempeno'];
            $items11 = $maser11['item'];
            $estado11 = $maser11['estado'];
        }

        $matrist12 = $asistencia->matrisres($curso, $grado, $nivel, '12', $evaluaci);
        while ($maser12 = mysqli_fetch_array($matrist12)) {
            $demoab12 = $maser12['clave'];
            $nivel12a = $maser12['nivelp'];
            $competencia12a = $maser12['competencia'];
            $desempeno12a = $maser12['desempeno'];
            $items12 = $maser12['item'];
            $estado12 = $maser12['estado'];
        }
        $matrist13 = $asistencia->matrisres($curso, $grado, $nivel, '13', $evaluaci);
        while ($maser13 = mysqli_fetch_array($matrist13)) {
            $demoab13 = $maser13['clave'];
            $nivel13a = $maser13['nivelp'];
            $competencia13a = $maser13['competencia'];
            $desempeno13a = $maser13['desempeno'];
            $items13 = $maser13['item'];
            $estado13 = $maser13['estado'];
        }

        $matrist14 = $asistencia->matrisres($curso, $grado, $nivel, '14', $evaluaci);
        while ($maser14 = mysqli_fetch_array($matrist14)) {
            $demoab14 = $maser14['clave'];
            $nivel14a = $maser14['nivelp'];
            $competencia14a = $maser14['competencia'];
            $desempeno14a = $maser14['desempeno'];
            $items14 = $maser14['item'];
            $estado14 = $maser14['estado'];
        }

        $matrist15 = $asistencia->matrisres($curso, $grado, $nivel, '15', $evaluaci);
        while ($maser15 = mysqli_fetch_array($matrist15)) {
            $demoab15 = $maser15['clave'];
            $nivel15a = $maser15['nivelp'];
            $competencia15a = $maser15['competencia'];
            $desempeno15a = $maser15['desempeno'];
            $items15 = $maser15['item'];
            $estado15 = $maser15['estado'];
        }

        $matrist16 = $asistencia->matrisres($curso, $grado, $nivel, '16', $evaluaci);
        while ($maser16 = mysqli_fetch_array($matrist16)) {
            $demoab16 = $maser16['clave'];
            $nivel16a = $maser16['nivelp'];
            $competencia16a = $maser16['competencia'];
            $desempeno16a = $maser16['desempeno'];
            $items16 = $maser16['item'];
            $estado16 = $maser16['estado'];
        }

        $matrist17 = $asistencia->matrisres($curso, $grado, $nivel, '17', $evaluaci);
        while ($maser17 = mysqli_fetch_array($matrist17)) {
            $demoab17 = $maser17['clave'];
            $nivel17a = $maser17['nivelp'];
            $competencia17a = $maser17['competencia'];
            $desempeno17a = $maser17['desempeno'];
            $items17 = $maser17['item'];
            $estado17 = $maser17['estado'];
        }

        $matrist18 = $asistencia->matrisres($curso, $grado, $nivel, '18', $evaluaci);
        while ($maser18 = mysqli_fetch_array($matrist18)) {
            $demoab18 = $maser18['clave'];
            $nivel18a = $maser18['nivelp'];
            $competencia18a = $maser18['competencia'];
            $desempeno18a = $maser18['desempeno'];
            $items18 = $maser18['item'];
            $estado18 = $maser18['estado'];
        }

        $matrist19 = $asistencia->matrisres($curso, $grado, $nivel, '19', $evaluaci);
        while ($maser19 = mysqli_fetch_array($matrist19)) {
            $demoab19 = $maser19['clave'];
            $nivel19a = $maser19['nivelp'];
            $competencia19a = $maser19['competencia'];
            $desempeno19a = $maser19['desempeno'];
            $items19 = $maser19['item'];
            $estado19 = $maser19['estado'];
        }

        $matrist20 = $asistencia->matrisres($curso, $grado, $nivel, '20', $evaluaci);
        while ($maser20 = mysqli_fetch_array($matrist20)) {
            $demoab20 = $maser20['clave'];
            $nivel20a = $maser20['nivelp'];
            $competencia20a = $maser20['competencia'];
            $desempeno20a = $maser20['desempeno'];
            $items20 = $maser20['item'];
            $estado20 = $maser20['estado'];
        }
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                ?>
                    <table id="course_table" class="table table-striped table-responsive" style="font-size: 11px;">
                        <thead>
...
google.charts.load('current', {'packages':['bar']});
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['1',<?php echo $porcentaje1;?>,<?php echo $porcentajed1;?>, <?php echo $porcentajed1b;?>,],
          ['2', <?php echo $porcentaje3;?>,<?php echo $porcentajed2;?>, <?php echo $porcentajed2b;?>,],
          ['3', <?php echo $porcentaje3;?>,<?php echo $porcentajed3;?>, <?php echo $porcentajed3b;?>,],
          ['4', <?php echo $porcentaje4;?>,<?php echo $porcentajed4;?>, <?php echo $porcentajed4b;?>,],
          ['5', <?php echo $porcentaje5;?>,<?php echo $porcentajed5;?>, <?php echo $porcentajed5b;?>,],
          ['6', <?php echo $porcentaje6;?>,<?php echo $porcentajed6;?>, <?php echo $porcentajed6b;?>,],
          ['7', <?php echo $porcentaje7;?>,<?php echo $porcentajed7;?>, <?php echo $porcentajed7b;?>,],
          ['8', <?php echo $porcentaje8;?>,<?php echo $porcentajed8;?>, <?php echo $porcentajed8b;?>,],
          ['9', <?php echo $porcentaje9;?>,<?php echo $porcentajed9;?>, <?php echo $porcentajed9b;?>,],
          ['10', <?php echo $porcentaje10;?>,<?php echo $porcentajed10;?>, <?php echo $porcentajed10b;?>,],
          ['11', <?php echo $porcentaje11;?>,<?php echo $porcentajed11;?>, <?php echo $porcentajed11b;?>,],
          ['12', <?php echo $porcentaje12;?>,<?php echo $porcentajed12;?>, <?php echo $porcentajed12b;?>,],
          ['13', <?php echo $porcentaje13;?>,<?php echo $porcentajed13;?>, <?php echo $porcentajed13b;?>,],
          ['14', <?php echo $porcentaje14;?>,<?php echo $porcentajed14;?>, <?php echo $porcentajed14b;?>,],
          ['15',<?php echo $porcentaje15;?>,<?php echo $porcentajed15;?>, <?php echo $porcentajed15b;?>,],
          ['16', <?php echo $porcentaje16;?>,<?php echo $porcentajed16;?>, <?php echo $porcentajed16b;?>,],
          ['17', <?php echo $porcentaje17;?>,<?php echo $porcentajed17;?>, <?php echo $porcentajed17b;?>,],
          ['18', <?php echo $porcentaje18;?>,<?php echo $porcentajed18;?>, <?php echo $porcentajed18b;?>,],
          ['19', <?php echo $porcentaje19;?>,<?php echo $porcentajed19;?>, <?php echo $porcentajed19b;?>,],
          ['20', <?php echo $porcentaje20;?>,<?php echo $porcentajed20;?>, <?php echo $porcentajed20b;?>,],
