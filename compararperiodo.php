...
?>
    ...
    <body>
        ...
        <input type="hidden" value="<?php echo $evaluacions; ?>" id="evaluaci">

        <br>
        <div class="container-fluid">
            <div class="card">
                <h6 class="card-header">.:: <i class="far fa-file-alt"></i> COMPARATIVO POR EVALUACIÓN </h6>
                <div class="card-body respuestag">

                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">EVALUACIÓN DE SALIDA</label>
                                <select class="form-control" id="anoa">
									...
									?>
										<option value="<?php echo $Lp['tabla']; ?>" selected><?php echo $Lp['descripcion'];  ?></option>
									<?php }; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">EVALUACIÓN DE INICIO</label>
        ...
        <script>
            $('.enviar').click(function() {
                ...
                var anoa = document.getElementById('anoa').value;
                var anob = document.getElementById('anob').value;
                ...
                if (nivel == '' || curso == '' || grado == '') {
                    ...
                    var ruta = "gestion=" + gestion + "&nivel=" + nivel + "&grado=" + grado + "&curso=" + curso + "&ugel=" + ugel + "&gestion=" + gestion + "&zona=" + zona + "&distrito=" + distrito + "&sexo=" + sexo + "&seccion=" + seccion + "&ie=" + ie + "&evaluaci=" + evaluaci + "&seleca=" + seleca + "&selecb=" + selecb + "&selecc=" + selecc + "&anoa=" + anoa + "&anob=" + anob;
                    $.ajax({
                            url: 'resultadosinformacionactualcomparara.php',
                            type: 'POST',
                            data: ruta,
                            dataType: 'html',
                            beforeSend: function() {
